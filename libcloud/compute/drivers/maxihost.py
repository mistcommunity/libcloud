...
class MaxihostNodeDriver(NodeDriver):
    ...
    def create_node(self, name, size, image, location, ex_ssh_key_ids=None):
        ...
        try:
            res = self.connection.request(
                "/devices", data=json.dumps(attr), method="POST"
            )
    ...
    def _to_location(self, data):
        ...
        return NodeLocation(id=data["slug"], name=name, country=None, driver=self)
    ...
    def _to_size(self, data):
        ...
        extra = {"specs": data["specs"], "regions": regions}
        return NodeSize(
            id=data["slug"],
            name=data["name"],

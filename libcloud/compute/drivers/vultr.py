...
class VultrNodeDriver(NodeDriver):
    ...
    def __new__(
        ...
        **kwargs,
        ...
        return super(VultrNodeDriver, cls).__new__(cls)
...
class VultrNodeDriverV2(VultrNodeDriver):
    ...
    def create_node(
        ...
        image=None,
        ex_ssh_key_ids=None,
        ex_private_network_ids=None,
        ex_snapshot=None,
        ex_enable_ipv6=False,
        ex_backups=False,
        ex_userdata=None,
        ex_ddos_protection=False,
        ex_enable_private_network=False,
        ex_ipxe_chain_url=None,
        ex_iso_id=None,
        ex_script_id=None,
        ex_image_id=None,
        ex_activation_email=False,
        ex_hostname=None,
        ex_tag=None,
        ex_firewall_group_id=None,
        ex_reserved_ipv4=None,
    ...
    def delete_key_pair(self, key_id):
        ...
        resp = self.connection.request("/v2/ssh-keys/%s" % key_id, method="DELETE")

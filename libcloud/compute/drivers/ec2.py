...
RESOURCE_EXTRA_ATTRIBUTES_MAP = {
    ...
    "subnet": {
        ...
        "zone": {"xpath": "availabilityZone", "transform_func": str},
        "vpc_id": {"xpath": "vpcId", "transform_func": str},
        "default": {"xpath": "defaultForAz", "transform_func": str},
    },
    "volume": {
...
class BaseEC2NodeDriver(NodeDriver):
    ...
    def ex_list_security_groups(self):
        ...
        for group in findall(
            ...
            id = findtext(element=group, xpath="groupId", namespace=NAMESPACE)
            vpc_id = findtext(element=group, xpath="vpcId", namespace=NAMESPACE)
